          ...
          <div className={styles.content}>
            {title && (
              <div className={styles.title}>
                ...
                {title.description && (
                  <div className={styles.titleKey}> {title.description}:&nbsp;</div>
                )}
...
ContentModal.propTypes = {
  ...
  onRequestClose: PropTypes.oneOfType([PropTypes.func, PropTypes.oneOf([false])]),
  onRequestBack: PropTypes.oneOfType([PropTypes.func, PropTypes.oneOf([false])]),
};
