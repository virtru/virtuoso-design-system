...
// import { ICON_MAP, ICONS } from './Icons';
...
const ContentModal = ({
  ...
  // const TitleIcon = ICON_MAP[titleIcon];
  // const SubtitleIcon = ICON_MAP[subtitleIcon];

  const TitleIcon = getIcon(titleIcon);
  const SubtitleIcon = getIcon(subtitleIcon);
