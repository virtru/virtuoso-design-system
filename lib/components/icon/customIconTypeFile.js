...
const CustomIconTypeFile = ({ name }) => iconTypeObject[name] || <GenericIcon />;

CustomIconTypeFile.propTypes = {
  name: PropTypes.oneOfType([
    PropTypes.oneOf([
      ...Object.keys(iconTypeObject),
      ...Object.keys(iconTypeObject).map((key) => key.toUpperCase()),
    ]),
    PropTypes.string,
  ]).isRequired,
};
